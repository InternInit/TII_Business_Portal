    ...
    render() {
        return (
            <div
                 ...
                 * 
                 */}
                <InfoHeader style={{ marginTop: '4vh' }}> Personal Information</InfoHeader>
                ...
                <Row>
                    <Row >
                        <Info >Address: </Info>
                        <AppInfo>3 Blueberry Lane, Northborough, Massachusetts 01532</AppInfo>
                    </Row>
                </Row>
                ...
                <InfoHeader>Educational History</InfoHeader>
                {
                    Schools.map(school => (
                        <SchoolContainer>
                            <SchoolName style={{ marginLeft: '5%', marginBottom: '1vh', marginTop: '4vh' }}>School Name</SchoolName>
                            <Row>
                                <SchoolInfo>School Location: Address, City, State, Zip Code</SchoolInfo>
                            </Row>
                            <Row style={{ paddingBottom: '4vh' }}>
                                <SchoolInfo style={{ width: '50%' }}>Course Concentration: Finance, Biology</SchoolInfo>
                                <SchoolInfo style={{ width: '50%' }}>Years Completed:  </SchoolInfo>
                            </Row>
                        </SchoolContainer>
